  ...
  computed: {
    text() {
      const content = {
        en: {
          title: "illustrations",
          description: "Logos, icons, and graphic experiments collected in one place.",
          aria: "Illustration showcase",
        },
        ru: {
          title: "иллюстрации",
          description: "Логотипы, иконки и графические эксперименты в одном месте.",
          aria: "Витрина иллюстраций",
        },
      };
